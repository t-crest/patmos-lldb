...
//
// Copied from ABIMacOSX_i386.h and altered to fit Patmos' needs.
//
//===----------------------------------------------------------------------===//

#ifndef liblldb_Unknwon_patmos_h_
#define liblldb_Unknwon_patmos_h_
...
private:
    ABIUnknown_Patmos() : lldb_private::ABI() { } // Call CreateInstance instead.
};
